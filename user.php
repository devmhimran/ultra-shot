...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <main>
    	...
    	$u_data = $conn -> query($user_data);
    	$f_data = $u_data -> fetch_assoc();
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="text-center user_image">
                                <img src="assets/img/user_img/<?php echo $f_data['user_photo']; ?>" class="" alt="...">
                              </div>
                        </div>
                        <div class="col-md-8">
                            <div class="user_name">
                                <h4><?php echo $f_data['user1_name']; ?></h4>
                            </div>
                            <div class="user_bio">
                                <p><?php echo $f_data['user_bio']; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
